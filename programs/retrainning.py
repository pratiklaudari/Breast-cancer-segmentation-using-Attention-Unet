...
model=keras.models.load_model('C:\major\Breast-cancer-segmentation-using-Attention-Unet\dataset\Aunetresults1.keras')
#callback
cb=[
    ModelCheckpoint('C:\major\Breast-cancer-segmentation-using-Attention-Unet\dataset\Aunetresults_re.keras',save_best_only=True),
    ShowProgress()]
#training
BATCH_SIZE = 8
